...
CallAcknowledgedEvent _$CallAcknowledgedEventFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$CallAcknowledgedEventToJson(
  CallAcknowledgedEvent instance,
) => <String, dynamic>{
  'id': instance.id,
  'type': instance.type,
  'op': instance.op,
...
CallDeclinedEvent _$CallDeclinedEventFromJson(Map<String, dynamic> json) =>
    CallDeclinedEvent(
      id: (json['id'] as num).toInt(),
      callId: json['call_id'] as String,
      userId: _parseIntFromString(json['user_id']),
...
CallCancelledEvent _$CallCancelledEventFromJson(Map<String, dynamic> json) =>
    CallCancelledEvent(
      id: (json['id'] as num).toInt(),
      callId: json['call_id'] as String,
      userId: _parseIntFromString(json['user_id']),
