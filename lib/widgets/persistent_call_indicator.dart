...
class PersistentCallIndicatorState extends State<PersistentCallIndicator> {
  ...
  Widget build(BuildContext context) {
    ...
    // Reactively listen to CallUiState flag to hide when call screens are visible
    return ValueListenableBuilder<bool>(
      valueListenable: CallUiState.isCallUiVisible,
      builder: (context, isCallUiVisible, child) {
        developer.log('CallUiState.isCallUiVisible changed: $isCallUiVisible', name: 'PersistentCallIndicator');
  ...
  void _forceEndCall(PerAccountStore store, String callId) {
    try {
      ...
      final callEndedEvent = zulip_events.CallEndedEvent(
